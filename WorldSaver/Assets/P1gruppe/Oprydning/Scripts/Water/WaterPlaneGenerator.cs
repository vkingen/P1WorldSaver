...
public class WaterPlaneGenerator : MonoBehaviour
{
    ...
    private Mesh GenerateMesh()
    {
        ...
        var verticies = new List<Vector3>(); //Vector3 because it stores verticies x,y,x
        var normals = new List<Vector3>(); //-"-
        var uvs = new List<Vector2>(); // Vector2 is just a plat plane, therfore only (x,z)
        ...
        for(int i = 0; i < vertCount * vertCount - vertCount; i++)
        {
            ...
            triangles.AddRange(new List<int>()
            {
                ...
                i, i+1, i+vertCount+1 //Second triangle
            });
        }
